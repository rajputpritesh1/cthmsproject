...
<body>
  <div class="container" id="content">
    ...
    <div class="main">
      <div class="top-bar">
        <div class="search">
          <span class="position">Admin Dashboard <i class="fa-solid fa-caret-right"></i> Reports</span>
        </div>
      ...
      <div class="add-btn">
        <h1>Report List</h1>
        <a href="./../forms/add-report.php"><i class="fa-solid fa-circle-plus"></i> Add Report</i></a>
    </div>  
      <div class="tables">
