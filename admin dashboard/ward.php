...
<head>
  ...
  <title>Admin Dashboard | Ward</title>
</head>
  ...
  <div class="container" id="content">
    <div class="sidebar">
      <ul>
        ...
        <li>
          <a href="./../admin dashboard/ward.php" class="active">
    ...
    <div class="main">
      <div class="top-bar">
        <div class="search">
          <span class="position">Admin Dashboard <i class="fa-solid fa-caret-right"></i> Ward</span>
        </div>
      ...
      <div class="add-btn">
        <h1>Ward List</h1>
          <a href="./../forms/add-ward.php"><i class="fa-solid fa-circle-plus"></i> Add Ward</a>
      </div> 
      <div class="tables">
