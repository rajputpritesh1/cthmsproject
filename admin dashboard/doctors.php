  ...
  <div class="container" id="content">
    <div class="sidebar">
      <ul>
        ...
        <li>
          <a href="./../admin dashboard/doctors.php" class="active">
    ...
    <div class="main">
      <div class="top-bar">
        <div class="search">
          <span class="position">Admin Dashboard <i class="fa-solid fa-caret-right"></i> Doctors</span>
        </div>
      ...
      <div class="add-btn">
        <h1>Doctors Liast</h1>
        <a href="./../forms/add-doctor.php"><i class="fa-solid fa-circle-plus"></i> Add Doctor</a>
    </div>
      <div class="cards">
        <div class="card">
