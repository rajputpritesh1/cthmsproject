...
<body>
  <div class="container" id="content">
    ...
    <div class="main">
      <div class="top-bar"> 
        <div class="search">
          <span class="position">Admin Dashboard <i class="fa-solid fa-caret-right"></i> Appointments</span>
        </div>
      ...
      <div class="add-btn">
        ...
        <a href="./../forms/add-appointment.php"><i class="fa-solid fa-circle-plus"></i> Add Appointment</a>
    </div> 
      <div class="tables">
