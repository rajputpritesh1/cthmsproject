...
<head>
  ...
  <link rel="stylesheet" href="./../stylesheet/employee-dashboard.css">
...
<body>
  <div class="container" id="content">
    ...
    <div class="main"> 
      <div class="top-bar">
        <div class="search">
          <span class="position">Admin Dashboard <i class="fa-solid fa-caret-right"></i> Employee</span>
        </div>
      ...
      <div class="add-btn">
        ...
        <a href="./../forms/add-employee.php"><i class="fa-solid fa-circle-plus"></i> Add Employee</a>
      </div> 
      <div class="tables">
