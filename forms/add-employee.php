...
<head>
  ...
  <link rel="stylesheet" href="./../stylesheet/employee-form.css"> 
  ...
  <div class="container" id="content">
    <div class="sidebar">
      <ul>
        ...
        <li>
          <a href="./../admin dashboard/employees.php" class="active">
    ...
    <div class="main">
      <div class="top-bar">
        <div class="search">
          <span class="position">Admin Dashboard <i class="fa-solid fa-caret-right"></i> Employee <i class="fa-solid fa-caret-right"></i> Add Employee</span>
        </div>
      ...
      <div class="form-container">
        ...
        <div class="form">
          <div>
            <label>Employee ID:
              <input type="text" name="emp_id" placeholder="CTHMS001" required>
            </label>
          </div>
          <div>
            <label>Full Name:
              <input type="text" name="emp_name" placeholder="Pritesh Kumar" required>
            </label>
          </div>
          <div>
            <label> Email ID:
              <input type="email" name="email" placeholder="dr.pritesh@cthms.org" required>
            </label>
          </div>
          <div>
            <label>Password
          ...
          <div>
            <label>Adhar No.
              <input type="text" name="adhar_no" placeholder="1234 1234 1234" required>
            </label>
          </div>
          <div>
            <label>Phone No.
              <input type="text" name="mobile" placeholder="9999999999" required>
            </label>
          </div>
          <div>
            <label>Join Date.
          ...
          <div>
            <label>Role.
              <select name="role">
                ...
                <option value="Doctor" name="role">Doctor</option>
