  ...
  <div class="container" id="content">
    <div class="sidebar">
      <ul>
        ...
        <li>
          <a href="./../admin dashboard/appointment.php" class="active">
    ...
    <div class="main">
      <div class="top-bar">
        <div class="search">
          <span class="position">Admin Dashboard <i class="fa-solid fa-caret-right"></i> Appointments <i class="fa-solid fa-caret-right"></i> Add Appointment</span>
        </div>
