...
<body>
  <div class="container" id="content">
    ...
    <div class="main">
      <div class="top-bar">
        <div class="search">
          <span class="position">Admin Dashboard <i class="fa-solid fa-caret-right"></i> Patient <i class="fa-solid fa-caret-right"></i> Add Patient</span>
        </div>
      ...
      <div class="form-container">
        ...
        <div class="form">
          ...
          <div>
            <label>Patient ID.
              <input type="email" name="patient_id" required>
            </label>
          </div>
          <div>
            <label>Email ID
          ...
          <div>
            <label>Doctor
              <select name="doctors">
                <option value="doc" name="doctor">Select Doctor</option>
                <option value="Pritesh" name="doc">Dr.Pritesh</option>
                <option value="Rittwick" name="doc">Dr.Rittwick</option>
                <option value="Arpan" name="doc">Dr.Arpan</option>
              </select>
            </label>
          </div>
          <div>
