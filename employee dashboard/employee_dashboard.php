...
<head>
  ...
  <link rel="stylesheet" href="./../stylesheet/employee_dashboard.css">
  ...
  <div class="container">
    <div class="sidebar">
      <ul>
        ...
        <li>
          <a href="./../employee dashboard/employee_dashboard.php" class="active">
    ...
    <div class="main">
      <div class="top-bar">
        <div class="search">
          <span class="position"><i class="fa-solid fa-caret-right"></i> Employee Dashboard</span>
        </div>
